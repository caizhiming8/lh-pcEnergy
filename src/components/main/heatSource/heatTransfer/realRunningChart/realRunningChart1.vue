    ...
    <div id="realRunningChart">
        <div class="realRunningChart">
            ...
            <div @mouseover="mouseoverEvent($event)">
                ...
                <div class="d14 ddd">{{p4_1}} : {{p4}} <br/> {{p4_10}} : {{p40}}</div>

                <div class="p1 ddd">{{p1}}</div>
                <div class="p2 ddd">{{p3_1}} : {{p3}} <br/> {{p3_10}} : {{p30}}</div>
                <div class="x1 ddd">{{x1}}</div>
                <div class="x2 ddd">{{x2}}</div>
                <div class="x3 ddd">{{x30}} : {{x3}} <br/>{{x3_10}} : {{x3_1}} <br/> {{x4Name}} : {{x4value}}  <br/>  {{v5name}} : {{x5value}}</div>

                <div class="z1 z">{{z1plName}} : {{z1plValue}} <br> {{z1dlName}} : {{z1dlValue}}</div>
                <div class="z2 z">{{z2plName}} : {{z2plValue}} <br> {{z2dlName}} : {{z2dlValue}}</div>
                <div class="z3 z">{{z3plName}} : {{z3plValue}} <br> {{z3dlName}} : {{z3dlValue}}</div>
            </div>
        </div>
    </div>
</template>
            ...
            if ("WebSocket" in window) {
                ...
                ws.onmessage = (evt)=>{
                    ...
                    if(JSON.stringify(obj) != "{}") {
                        ...
                        this.x3_1 = obj.data8x6x1 == undefined? "-" : obj.data8x6x1.value;
                        this.x3_10 = obj.data8x6x1 == undefined? "-" : obj.data8x6x1.dataName;

                        this.x4value = obj.data11x5x1 == undefined? "-" : obj.data11x5x1.value;
                        this.x4Name = obj.data11x5x1 == undefined? "-" : obj.data11x5x1.dataName;
                        this.x5value = obj.data11x6x1 == undefined? "-" : obj.data11x6x1.value;
                        this.v5name = obj.data11x6x1 == undefined? "-" : obj.data11x6x1.dataName;

                        this.z1plName = obj.data1x3x4 == undefined ? "-" : obj.data1x3x4.dataName;
                        this.z1plValue = obj.data1x3x4 == undefined ? "-" : obj.data1x3x4.value;
                        this.z1dlName = obj.data2x3x4 == undefined ? "-" : obj.data2x3x4.dataName;
                        this.z1dlValue = obj.data2x3x4 == undefined ? "-" : obj.data2x3x4.value;

                        this.z2plName = obj.data1x3x5 == undefined ? "-" : obj.data1x3x5.dataName;
                        this.z2plValue = obj.data1x3x5 == undefined ? "-" : obj.data1x3x5.value;
                        this.z2dlName = obj.data2x3x5 == undefined ? "-" : obj.data2x3x5.dataName;
                        this.z2dlValue = obj.data2x3x5 == undefined ? "-" : obj.data2x3x5.value;

                        this.z3plName = obj.data1x3x6 == undefined ? "-" : obj.data1x3x6.dataName;
                        this.z3plValue = obj.data1x3x6 == undefined ? "-" : obj.data1x3x6.value;
                        this.z3dlName = obj.data2x3x6 == undefined ? "-" : obj.data2x3x6.dataName;
                        this.z3dlValue = obj.data2x3x6 == undefined ? "-" : obj.data2x3x6.value;
                    }else{
                        this.z1plName = "-";
                        this.z1plValue = "-";
                        this.z1dlName = "-";
...
#realRunningChart{
    .realRunningChart{
		background: url(../../../../../../static/img/zonghebingfanglou.jpg) no-repeat 0 0;
