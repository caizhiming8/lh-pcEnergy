        ...
        <div class="powerSetting">
            <div class="setting-main" ref="settingMain">
                <div class="setting-tree" ref="settingTree">
                    <el-tree accordion :data="data" :props="defaultProps" highlight-current @node-click="handleNodeClick"></el-tree>
                </div>
                <div class="setting-table">
                    ...
                    <el-table :data="tableData" style="margin-top: 20px" :row-style="{height:0}" :cell-style="{padding:'8px'}" :header-cell-style="{background:'#F5F7FA',color:'#606266', height: '0px', padding: '5px'}" v-loading = "loading">
                        <el-table-column prop="deviceName" label="设备名称" sortable align='center'></el-table-column>
    					<el-table-column prop="typeName" label="数据类型" sortable align='center'></el-table-column>
                        <el-table-column prop="maxNum" label="上限" sortable align='center'></el-table-column>
                        <el-table-column prop="minNum" label="下限" sortable align='center'></el-table-column>
                        <el-table-column label="告警级别" sortable align='center'>
                        ...
                        <el-table-column label="操作" align='center' width="180">
                            <template slot-scope="scope">
                                <el-button @click="handleClick(scope.row, scope.$index)" size="small">修改</el-button>
