<template>
    <div id="alertManagementSetting">
        <div class="alertManagementSetting">
            <div class="setting-main" ref="settingMain">
                ...
                <div class="setting-table">
                    ...
                    <div class="placeDiv">
                        <el-table :data="tableData" style="margin-top: 20px" :row-style="{height:0}" :cell-style="{padding:'8px 0'}" :header-cell-style="{background:'#F5F7FA',color:'#606266', height: '0px', padding: '15px '}" v-loading = "loading">
